...
def file1 = new File('D:/groovy1.txt')
def file2 = new File('D:/groovy2.txt')
def file3 = new File('D:/groovy3.txt')
...
assert ['D:/groovy1.txt', 'D:/groovy2.txt', 'D:/groovy3.txt'] == files
